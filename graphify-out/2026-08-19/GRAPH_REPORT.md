...
## Corpus Check
- 34 files · ~16,916 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 272 nodes · 567 edges · 14 communities (13 shown, 1 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2ed276a8`
...
Cohesion: 0.22
Nodes (15): deal, fullDeck(), RANKS, seededRng(), shuffledDeck(), SUITS, Card, HandRole (+7 more)
...
Cohesion: 0.22
Nodes (8): Art assets — spec, Cards, Layout budget — and why it's asserted, not eyeballed, Outline system — the "sticker" look, Output, Palette — cabin by the fire, Regenerating, Table

## Knowledge Gaps
- **64 isolated node(s):** `Palette — cabin by the fire`, `Outline system — the "sticker" look`, `Cards`, `Layout budget — and why it's asserted, not eyeballed`, `Table` (+59 more)
...
- **Why does `Card` connect `types.ts` to `reducer.ts`, `useGame.ts`, `rules.ts`?**
