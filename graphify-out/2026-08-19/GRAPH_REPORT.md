...
## Corpus Check
- 38 files · ~27,062 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 352 nodes · 742 edges · 19 communities (18 shown, 1 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `56365fe9`
...
Cohesion: 0.10
Nodes (52): outcomes, pick(), playRandomDeal(), seededRng(), TERMINAL_PHASES, DEFAULT_CONFIG, deal, fullDeck() (+44 more)
...
Cohesion: 0.09
Nodes (32): PlayerView, App(), BOT, freshSeed(), HUMAN, useGame(), Expression, useOpponentExpression() (+24 more)
...
- **Why does `Card` connect `types.ts` to `Game.tsx`, `rules.ts`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `Player` connect `types.ts` to `Game.tsx`?**
