...
## Corpus Check
- 34 files · ~14,217 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 252 nodes · 536 edges · 14 communities (13 shown, 1 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6e29f25a`
...
Cohesion: 0.16
Nodes (24): body_color(), draw_card_frame(), draw_face(), draw_glyph(), draw_head(), draw_shoulders(), _ellipse_mask(), main() (+16 more)
...
Cohesion: 0.14
Nodes (35): outcomes, pick(), playRandomDeal(), seededRng(), TERMINAL_PHASES, DEFAULT_CONFIG, SUITS, actingHand() (+27 more)
...
Cohesion: 0.24
Nodes (13): deal, fullDeck(), RANKS, seededRng(), shuffledDeck(), HandRole, LonerTier, Phase (+5 more)
...
- **Why does `Card` connect `rules.ts` to `reducer.ts`, `useGame.ts`, `types.ts`?**
