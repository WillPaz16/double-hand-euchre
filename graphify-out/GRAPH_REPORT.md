...
## Corpus Check
- 38 files · ~23,972 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 341 nodes · 711 edges · 15 communities (13 shown, 2 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6a6bdc9e`
...
Cohesion: 0.05
Nodes (73): _arm(), _assert_art_clear_of_indices(), body_color(), _clamp(), _collar(), composite_sprite(), contact_shadow(), darken() (+65 more)
...
Cohesion: 0.07
Nodes (48): deal, fullDeck(), RANKS, seededRng(), shuffledDeck(), SUITS, Action, Card (+40 more)
...
- **Why does `Card` connect `types.ts` to `reducer.ts`, `rules.ts`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `Player` connect `types.ts` to `reducer.ts`?**
