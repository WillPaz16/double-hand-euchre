...
/** coveredClipPath is the actual pip-reveal math — the SUM OF EXPOSED PIPS is the score
 *  (direct user feedback: "the amount of pips showing is the number of points"), which needs
 *  single-pip granularity even on odd scores. Asserted directly on the polygon's structure
 *  rather than through jsdom's computed styles, which never run real layout. */
